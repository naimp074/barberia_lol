...
DROP POLICY IF EXISTS "Barbers can view all" ON public.barbers;
CREATE POLICY "Barbers can view all" ON public.barbers
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "Barbers can insert" ON public.barbers;
CREATE POLICY "Barbers can insert" ON public.barbers
  FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Barbers can update" ON public.barbers;
CREATE POLICY "Barbers can update" ON public.barbers
  FOR UPDATE USING (true);

DROP POLICY IF EXISTS "Barbers can delete" ON public.barbers;
...
DROP POLICY IF EXISTS "Service types can view all" ON public.service_types;
CREATE POLICY "Service types can view all" ON public.service_types
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "Service types can insert own" ON public.service_types;
CREATE POLICY "Service types can insert own" ON public.service_types
  FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Service types can update own" ON public.service_types;
CREATE POLICY "Service types can update own" ON public.service_types
  FOR UPDATE USING (true);

DROP POLICY IF EXISTS "Service types can delete own" ON public.service_types;
...
-- AND table_name IN ('users', 'barbers', 'service_types', 'services');
